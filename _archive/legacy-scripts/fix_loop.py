            ...
            <div class="container mx-auto px-6 max-w-5xl">
                ...
                <div class="relative py-12 px-8 md:px-16 max-w-4xl mx-auto">
                    ...
                    <div class="relative grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 w-full mt-6 mb-6">
                        <!-- Center Label -->
                        <div class="hidden md:flex absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-surface px-4 py-2 border border-border/50 text-muted uppercase tracking-[0.2em] text-[10px] font-bold z-20">
                            FOCUS
                        </div>
                        ...
                        <div class="hidden md:block absolute inset-0 pointer-events-none z-10">
                            ...
                            <!-- TR to BL Diagonal (crosses center) -->
                            <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-accent text-2xl leading-none" style="margin-left: -20px; margin-top: 20px;">&swarrow;</div>
                            
                            <!-- BR to TL Diagonal (crosses center) -->
                            <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-accent text-2xl leading-none" style="margin-left: 20px; margin-top: -20px;">&nwarrow;</div>
                        </div>
                ...
                <div class="text-center mt-12 max-w-3xl mx-auto space-y-4 px-4">
                    <p class="text-lg text-offwhite font-medium">The Business Loop a continuous cycle that moves from SEE-ing what's next to DECIDE-ing the best path, then to DO and execute the plan real), and finally IMPROVE by learning from results.</p>
                    <p class="text-lg text-offwhite font-medium">I fill the gaps in this loop, so that you as the owner can focus on making the final decisions. That is the deal.</p>
                </div>
            </div>
        </section>"""
