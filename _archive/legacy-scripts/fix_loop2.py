            ...
            <div class="container mx-auto px-6 max-w-5xl">
                ...
                <div class="relative py-12 px-8 md:px-16 max-w-4xl mx-auto">
                    ...
                    <div class="relative grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 w-full mt-6 mb-6">
                        <!-- Center Label -->
                        <div class="hidden md:flex absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-[#121824] px-4 py-2 border border-border/50 text-muted uppercase tracking-[0.2em] text-[10px] font-bold z-20">
                            FOCUS
                        </div>
